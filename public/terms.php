...
<body id="home">
    ...
    <section class="dfd-gettingstarted-container _max-width__1000 _padding-top-bottom__large">
        ...
        <h3>Introduction</h3>
        <p>The Drip Fed Ltd. (“we,” “us,” or “our”) website and any related services, including any software, mobile applications, and other online products and services (collectively, the “Services”) are provided subject to these Terms of Use (the “Terms”).</p>
        <p>By visiting our site and/ or purchasing something from us, you engage in our “Service” and agree to be bound by the following Terms of Use, including those additional terms and conditions and policies referenced herein and/or available by hyperlink with our website or documentation. These Terms of Use apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content.</p>
        <p>Please read these Terms of Use carefully before accessing or using our site. By accessing or using any part of the site, you agree to be bound by these Terms of Use. If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services. If these Terms of Use are considered an offer, acceptance is expressly limited to these Terms of Use.</p>
        <p>Any new features or tools which are added to the current site shall also be subject to the Terms of Use. Your continued use of or access to the website following the posting of any changes constitutes acceptance of those changes.</p>

        <h3>Acceptance of Terms</h3>
        <p>By using our Services, you agree to these Terms, which constitute a legally binding agreement between you and us. If you do not agree to these Terms, you may not use our Services.</p>
        ...
        <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of our Service, use of the Service, or access to the Service or any contact on our website through which the service is provided, without express written permission by us.</p>
        <p>The headings used in this agreement are included for convenience only and will not limit or otherwise affect these Terms.</p>

        <h3>Accuracy, Completeness and Timeliness of Information</h3>
        <p>We are not responsible if information made available on our site is not accurate, complete, or current. Any reliance on the material on this site is at your own risk.</p>
        ...
        <h3>Modifications to Service or Prices</h3>
        <p>Prices for our Services are subject to change without notice.</p>
        <p>We reserve the right at any time to modify or discontinue the Services (or any part or content thereof) without notice at any time.</p>
        <p>We shall not be liable to you or to any third-party for any modification, price change, suspension, or discontinuance of a Service.</p>

        <h3>Products or Services</h3>
        <p>Certain products or services may be available exclusively online through our website. These products or services may have limited quantities, usage, or features.</p>
        ...
        <p>We reserve the right to discontinue any product at any time. Any offer for any product or service made on our site is void where prohibited.</p>
        ...
        <p>We may also, in the future, offer new services and/or features through the website (including, the release of new tools and resources). Such new features and/or services shall also be subject to these Terms of Use, unless stated otherwise.</p>
