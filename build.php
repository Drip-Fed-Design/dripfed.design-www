...
<div class="<?= $globalPrefix; ?>-body-container">
    <section class="<?= $globalPrefix; ?>-intro-container _max-width__800 _padding-top-bottom__large">
        <h1 class="_text-align__center">Drip Fed is <span class="_word-wrap">solving problems</span> with<br /> an <span class="_word-under">unlimited product design</span> subscription<span class="_word-stop"></span></h1>
        <p class="_text-align__center">We provide our clients with best-in-class digital product design solutions, with a ton of commitment and personality, lower costs and less bureaucracy.</p>
        ...
        <div class="_padding-top-bottom__default" id="anchor-gettingstarted">
            ...
            <div class="<?= $globalPrefix; ?>-grid-container -column__third -column-gap__large">
                <div class="_text-align__center">
                    ...
                    <h4><strong>1.</strong> Choose a design subscription that suits you.</h4>
                ...
                <div class="_text-align__center">
                    ...
                    <h4><strong>3.</strong> Submit & collaborate design requests via Wrike.</h4>
                    <span class="_split -orange"></span>
                </div>
            </div>
        </div>
