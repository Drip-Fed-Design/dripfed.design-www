        ...
        <div class="<?= $globalPrefix; ?>-grid-container -column__third-cta -column-gap__xlarge">
            ...
            <div class="_padding-top-bottom__default">
                ...
                <div class="<?= $globalPrefix; ?>-button-container _text-align__center">
                    ...
                    <a data-cabin-event="CTA Lower / Book Call" href="<?= $globalDomainRoot; ?>book-call" target="_blank" class="__button -white" title="Book an introduction call with <?= $globalTitle; ?>, find out about our unlimited digital design subscriptions design as a service" hreflang="en">Let's chat</a>
                </div>
